...
if (file_exists($cashu_wc_autoload)) {
  ...
  spl_autoload_register(function ($class) {
    if (strpos($class, 'Cashu\\WC\\') !== 0) {
      return;
    }
    $relative = substr($class, strlen('Cashu\\WC\\'));
...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_enqueue_script($script_handle, $script_url, [], CASHU_WC_VERSION, true);
  ...
  wp_localize_script($script_handle, 'cashu_wc', [
    'ajax_url' => admin_url('admin-ajax.php'),
